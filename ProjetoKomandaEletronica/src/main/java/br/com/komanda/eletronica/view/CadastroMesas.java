...
public class CadastroMesas extends JFrame {
	 ...
	 */
	public CadastroMesas() throws ParseException {

		setUndecorated(true);
		setTitle("CADASTRO DE MESAS");
		setIconImage(Toolkit.getDefaultToolkit().getImage(CadastroMesas.class.getResource("/img/user_edit.png")));
		...
		btnNewButton.setIcon(new ImageIcon(CadastroMesas.class.getResource("/img/cancel.png")));
		...
		btnSalvar.setIcon(new ImageIcon(CadastroMesas.class.getResource("/img/user_add.png")));
		...
		btnApagar.setIcon(new ImageIcon(CadastroMesas.class.getResource("/img/user_delete.png")));
		...
		btnEditar.setIcon(new ImageIcon(CadastroMesas.class.getResource("/img/user_edit.png")));
		...
		btnFrente.setIcon(new ImageIcon(CadastroMesas.class.getResource("/img/arrow_right.png")));
		...
		btnTras.setIcon(new ImageIcon(CadastroMesas.class.getResource("/img/arrow_left.png")));
